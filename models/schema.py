...
db.define_table('Debit_Credit',
    ...
    Field('brand_code_id','reference Stand_Rent_Brand',ondelete='NO ACTION',requires=IS_IN_DB(db,db.Stand_Rent_Brand.id,'%(brand_code)s - %(brand_name)s',zero='Choose Brand Name')),
    Field('total_amount','decimal(10,2)',default=0),
